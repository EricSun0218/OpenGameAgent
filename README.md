...
| DevTools | Bounded JSONL recordings, named runtime-stage timing, provider-facing/framework/authoritative-host attribution, failure and durable-write metrics, concurrent benchmark runtime, observation-only replay, and offline/CI evaluation rules |
