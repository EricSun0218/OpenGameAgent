...
public partial class LivingWorldPatternsSample : global::Godot.Node
{
    public override void _Ready()
    {
        ...
        {
            global::Godot.GD.PushError("GODOT_LIVING_WORLD_SAMPLE_FAIL");
            return;
        }
        global::Godot.GD.Print("GODOT_LIVING_WORLD_SAMPLE_PASS");
    }

    public static IReadOnlyList<LivingWorldActorSignal> SampleSignals() => new[]
    {
        new LivingWorldActorSignal
        {
            ActorId = "dialogue-npc",
            HasDirectPlayerInput = true,
            PendingMessages = 1,
            Salience = 1,
            LastEvaluatedGameTick = 119
        },
        new LivingWorldActorSignal
        {
            ActorId = "monthly-governor",
            PendingTriggers = 1,
            Salience = 0.5,
            LastEvaluatedGameTick = 30
        },
        new LivingWorldActorSignal
        {
            ActorId = "nearby-worker",
            DistanceToNearestPlayer = 20.5,
            PendingTriggers = 2,
            Salience = 0.6,
            LastEvaluatedGameTick = 110
        },
        new LivingWorldActorSignal
        {
            ActorId = "builder",
    ...
    private static WorkflowStageDefinition Stage(
        ...
        params string[] dependsOn) => WorkflowStageDefinition.CreateStep(
            id,
