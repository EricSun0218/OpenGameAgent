...
public sealed class ProviderCapabilities
{
    ...
    public bool StructuredInput { get; set; } = true;
    ...
    public ProviderCapabilities Clone()
    {
        return new ProviderCapabilities
        {
            ...
            RequiresCompleteToolPairs = RequiresCompleteToolPairs,
            TextInput = TextInput,
            ...
            MaxTools = MaxTools,
            MaxToolSchemaUtf8Bytes = MaxToolSchemaUtf8Bytes,
...
public sealed class ProviderRouteIdentity
{
        ...
        ProviderCapabilities capabilities)
    {
        ...
        capabilityDigest.Add(
            "textInput",
            capabilities.TextInput ? "true" : "false");
        capabilityDigest.Add(
            "structuredInput",
            capabilities.StructuredInput ? "true" : "false");
        capabilityDigest.Add(
            "imageInput",
            capabilities.ImageInput ? "true" : "false");
        capabilityDigest.Add(
            "audioInput",
            capabilities.AudioInput ? "true" : "false");
        capabilityDigest.Add(
            "reasoningEffort",
            capabilities.ReasoningEffort ? "true" : "false");
        capabilityDigest.Add(
            "reasoningTokenBudget",
            capabilities.ReasoningTokenBudget ? "true" : "false");
        capabilityDigest.Add(
            "samplingControls",
            capabilities.SamplingControls ? "true" : "false");
        capabilityDigest.Add(
            "seed",
            capabilities.Seed ? "true" : "false");
        capabilityDigest.Add(
            "promptCaching",
            capabilities.PromptCaching ? "true" : "false");
        capabilityDigest.Add(
            "automaticPromptCaching",
            capabilities.AutomaticPromptCaching ? "true" : "false");
        capabilityDigest.Add(
            "promptCacheKey",
            capabilities.PromptCacheKey ? "true" : "false");
        capabilityDigest.Add(
            "promptCacheRetention",
            capabilities.PromptCacheRetention ? "true" : "false");
        capabilityDigest.Add(
            "statefulContinuation",
            capabilities.StatefulContinuation ? "true" : "false");
    ...
    internal ProviderCapabilities CapabilitiesSnapshot() =>
        _capabilities.Clone();
