    ...
    ICalibratingProviderPromptTokenEstimator
{
        ...
        IProviderPromptTokenEstimator? promptTokenEstimator = null)
    {
        ...
        _capabilities = new ProviderCapabilities
        {
            ...
            ReasoningEffort = _options.SupportsPerRequestReasoning,
            SamplingControls = _options.SupportsSamplingControls,
            Seed = _options.SupportsSeed,
            PromptCaching = _options.AutomaticPromptCaching
                            || _options.SupportsPromptCacheKey
                            || _options.SupportsPromptCacheRetention,
            AutomaticPromptCaching = _options.AutomaticPromptCaching,
            PromptCacheKey = _options.SupportsPromptCacheKey,
            PromptCacheRetention = _options.SupportsPromptCacheRetention,
