...
public sealed class GameAgentRuntimeBuilder : IAsyncDisposable
{
    ...
    public GameAgentRuntimeBuilder UseOpenAiResponsesProvider(
        OpenAiResponsesProviderOptions options,
        INativeApiCredentialSource credentials)
    {
        ThrowIfFinished();
        var transport = new HttpClientNativeProviderTransport();
        try
        {
            _providers.Add(
                new OpenAiResponsesStreamingProvider(
                    options,
                    credentials,
                    transport));
            _ownedDisposables.Add(transport);
    ...
    public GameAgentRuntimeBuilder UseGeminiInteractionsProvider(
        ...
        INativeApiCredentialSource credentials)
    {
        ...
        {
            _providers.Add(
                new GeminiInteractionsStreamingProvider(
                    options,
                    credentials,
                    transport));
            _ownedDisposables.Add(transport);
    ...
    public BuiltGameAgentRuntime Build()
    {
        ...
        try
        {
            ...
            var modelCatalog = ProviderModelCatalog.Capture(_providers);
            var inspector = new RuntimeInspector(_store);
...
public sealed class BuiltGameAgentRuntime : IAsyncDisposable
{
    ...
    public ProviderModelCatalog Models { get; }

    public RuntimeInspector Inspector { get; }
