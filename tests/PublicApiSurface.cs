...
namespace OpenGameAgent.Testing;

internal static class PublicApiSurface
{
    public static string Hash(Assembly assembly) =>
        Convert.ToHexString(SHA256.HashData(Encoding.UTF8.GetBytes(Describe(assembly))));
