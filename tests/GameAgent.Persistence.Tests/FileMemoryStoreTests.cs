...
public sealed class FileMemoryStoreTests
{
    ...
    public async Task FullRecordRecoversAcrossRestartAndDeletePersists()
    {
        ...
        try
        {
            ...
            {
                Assert.Equal(1, await recovered.GetRevisionAsync(cancellationToken: TestContext.Current.CancellationToken));
    ...
    public async Task ConcurrentMutationsAreSerializedAndRecoverWithoutGaps()
    {
        ...
        try
        {
            ...
            await using (var store = new FileMemoryStore(path))
            {
                ...
                Assert.Equal(32, await store.GetRevisionAsync(cancellationToken: TestContext.Current.CancellationToken));
            }
    ...
    public async Task ExplicitNullForRequiredCollectionFailsClosed()
    {
        ...
        try
        {
            ...
            var original = await File.ReadAllBytesAsync(path, cancellationToken: TestContext.Current.CancellationToken);
            ...
            Buffer.BlockCopy(
                ...
                4);
            await File.WriteAllBytesAsync(path, invalidFrame, cancellationToken: TestContext.Current.CancellationToken);
