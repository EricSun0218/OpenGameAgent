...
public sealed class LocalSkillPackageTests
{
    ...
    public void IdenticalReloadKeepsGenerationAndAllDigestsStable()
    {
        ...
        var first = catalog.Reload();
        var second = catalog.Reload();
