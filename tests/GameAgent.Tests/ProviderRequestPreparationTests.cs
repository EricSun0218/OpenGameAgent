...
public sealed class ProviderRequestPreparationTests
{
    ...
    public void MessageDigestCanonicalizesJsonObjectOrderAndEscapes()
    {
        ...
        Assert.Equal(
            ProviderRequestSanitizer.DigestMessages(first),
            ProviderRequestSanitizer.DigestMessages(equivalent));
        Assert.NotEqual(
            ProviderRequestSanitizer.DigestMessages(first),
            ProviderRequestSanitizer.DigestMessages(changed));
    }
    ...
    public void NearLimitJsonStringDigestRejectsWithoutLargeMaterialization()
    {
        ...
        _ = Assert.Throws<InvalidDataException>(
            () => ProviderRequestSanitizer.DigestMessages(messages));
        var allocated =
