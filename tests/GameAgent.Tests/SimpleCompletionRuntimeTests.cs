...
public sealed class SimpleCompletionRuntimeTests
{
    ...
    public async Task EmptyCompletionFailsBeforeProviderDispatch()
    {
        ...
        await Assert.ThrowsAsync<ArgumentException>(
            () => runtime.CompleteAsync(
                    new SimpleCompletionRequest(), cancellationToken: TestContext.Current.CancellationToken)
                .AsTask());
    ...
    public async Task CompletionSnapshotsTokenLimitsBeforeProviderAdmission()
    {
        ...
        var first = runtime.CompleteAsync(
            ...
            .AsTask();
        await provider.FirstEntered.Task.WaitAsync(TimeSpan.FromSeconds(2), cancellationToken: TestContext.Current.CancellationToken);
        ...
        var second = runtime.CompleteAsync(queued, cancellationToken: TestContext.Current.CancellationToken).AsTask();
